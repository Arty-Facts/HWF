...
func DataAddPath(builder *flatbuffers.Builder, path flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(path), 0)
}
func DataAddFilename(builder *flatbuffers.Builder, filename flatbuffers.UOffsetT) {
